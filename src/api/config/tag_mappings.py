...
【重要說明】
1. TAG_ALIAS_MAP - 技術必須，用於解析別名
2. QUICK_ADJUSTMENTS - 參考資料，供開發者理解
   - Agent 不強制使用此映射
   - Agent 應自然理解使用者的自由文字調整
   - 此映射僅作為「可能的調整方向」參考
3. 前端不顯示固定按鈕，改用自由文字輸入框
"""
...
# 
# 【用途說明】
# - 供開發者理解「更夢幻」等調整可能對應的標籤操作
# - Agent 不需要強制使用此映射
# - Agent 應自然理解使用者的任何調整需求
# - 此映射僅為「靈感參考」，非「硬性規則」
# 
# 【前端實作】
# - 不要顯示固定按鈕
# - 改用自由文字輸入框：「想調整？告訴我你的想法」
# - 讓 Agent 靈活理解任何調整（更可愛、加魔法、換夜景...）
# ============================================
