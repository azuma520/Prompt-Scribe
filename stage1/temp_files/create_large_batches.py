...
output_dir = 'stage1/output/large_batches'
batch_size = 5000  # 每批 5000 筆記錄

print('開始生成大批次 SQL 文件...')
...
with open(csv_path, 'r', newline='', encoding='utf-8') as csvfile:
    ...
    for row in csv_reader:
        ...
        if len(batch_data) >= batch_size:
            ...
            print(f'批次 {batch_count:3d} 已生成: {len(batch_data):,} 筆記錄, {file_size:,} bytes (總計: {total_processed:,})')
            batch_data = []
